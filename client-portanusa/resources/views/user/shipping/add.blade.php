            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="information">
                        ...
                        @endif
                        <form action="/account/shipping/add" id="shipping-form" method="POST" role="form">
                            {{ csrf_field() }}
                            <table class="table mt-3">
                                <tr>
                                    <td><input type="text" class="form-control " name="label" placeholder="Shipping label ex: Kantor" /></td>
                                    <td><input type="text" class="form-control " name="receiver_name" placeholder="Receiver name" /></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="city" name="city_id" class="form-control ml-0" disabled>
                                            <option value="">City</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td><input type="text" class="form-control " name="postal_code" onkeypress="return isNumberKey(event)" maxlength="5" placeholder="Postal Code" /></td>
                                    <td><input type="text" class="form-control " name="receiver_phone" maxlength="12" onkeypress="return isNumberKey(event)" placeholder="Receiver phone" /></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
