            ...
            <div class="col-md-12 col-lg-6">
                <div class="product_description">
                    ...
                    <div class="product-package">
                        <h4>Package Deal</h4>
                        <h5><a href="/base/{{ $product_base->url }}">Without Accessories</a></h5>
                        @foreach($package_items as $item)
                        <h5 class="{{ ($item->url == $product->url) ? 'active' : '' }}"><a href="/package/{{ $item->url }}">{{ $item->label }}</a></h5>
                        @endforeach
                    </div>
                    @endif
                    ...
                    <div class="message-content mb-3">
                        ...
                        <form method="POST" role="form" id="productDiscussionForm" action="{{ url('product/discussion') }}" autocomplete="off">
                            ...
                            <div class="text-right mt-3">
                                ...
                                @else
                                <a href="javascript:;" onclick="showLoginModal()" class="btn btn-primary" type="submit">Sign in</a>
                                @endif
                            </div>
                        </form>
                    </div>
...
<!-- Recently Viewed -->
@if(count($products_package_compositions) != 0)
<div class="viewed">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="viewed_title_container">
                    <h3 class="viewed_title">Product on this Package</h3>
                </div>
                ...
                <div class="viewed_slider_container">
                    ...
                    <div class="owl-carousel owl-theme viewed_slider">
                        <?php $products = $products_package_compositions; ?>
            ...
            item.addEventListener('click', function(fn) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('.wishlist_count').html(result.totalWishlist);
                    }
                });
            });
        }
