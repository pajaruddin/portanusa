...
<div class="home">
    <div class="home_background" style="background-image: url('{{ $banner_image }}'); background-size: 80%; background-position: center center;"></div>
            ...
            <div class="col-md-3 mb-3">
                ...
                <div class="shop_sidebar">
                    ...
                    <div class="sidebar_section">
                        <div class="sidebar_title">Related Categories</div>
                        <ul class="sidebar_categories">
                            @foreach($category_child as $child)
                            <li><a href="/product/category/{{ $child->url }}">{{ $child->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    @endif
