...
class HomeController extends Controller {
    ...
    function getLists() {
        ...
        return Datatables::of($orders)
                ...
                ->addColumn('action', function ($order) {
                    ...
                    $action_button = "";
                    $action_button .= '<a href="' . url("/dashboard/detail", $order->id) . '" class="btn btn-circle btn-icon-only btn-primary" title="Detail Order"><i class="fa fa-search"></i></a>';
    ...
    function getDetailOrder($id) {
        ...
        return view('home.detail')->with($data);
    }
    ...
    public function update(Request $request, $id) {
        ...
        if (!$validator->fails()) {
            ...
            if ($order->save()) {
                ...
                return redirect('/')->with('alert-success', trans('messages.success_save', ['menu' => 'Order']));
            } else {
