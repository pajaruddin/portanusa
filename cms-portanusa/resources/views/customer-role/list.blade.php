        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Kelompok Pelanggan</span>
                </div>
                <div class="actions">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="/master-customer-role/add-customer-role">
            ...
            <div class="portlet-body ">
                ...
                <table class="table table-striped table-bordered dt-responsive" id="tbl-customer-role">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Nama</th>
...
$(function () {
    var table = $('#tbl-customer-role').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.$menu.'/data-customer-role')}}",
        columns: [
    ...
    $("#tbl-customer-role").on("click", "#delete", function (event, state) {
        var id = $(this).data('id');

        var n = new Noty({
            text: 'Hapus Kelompok Pelanggan ?',
            layout: 'center',
            modal: true,
            buttons: [
                Noty.button('YES', 'btn btn-success', function () {
                    $.ajax({
                        ...
                        url: "{{url('/'.$menu.'/'.'delete-customer-role')}}",
                        data: {
                            id: id
                        },
                        type: 'POST',
