        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Video</span>
                </div>
                <div class="actions">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="/master-video/add-video">
                        Tambah Video
                    </a>
                </div>
            </div>
            <div class="portlet-body ">
                ...
                <table class="table table-striped table-bordered dt-responsive" id="tbl-video">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>id</th>
...
$(function () {
    var table = $('#tbl-video').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.'master-video'.'/data-video')}}",
        columns: [
    ...
    $('#tbl-video').on('switchChange.bootstrapSwitch', 'input[name="active"]', function (event, state) {
        var id = $(this).data('id');
        var active = "";
        if (state) {
            active = 'T';
        ...
        $.ajax({
            ...
            url: "{{url('/'.'master-video'.'/active-master-video')}}",
            data: {
                active: active,
                id: id
            },
    ...
    $("#tbl-video").on("click", "#delete", function (event, state) {
        var id = $(this).data('id');
