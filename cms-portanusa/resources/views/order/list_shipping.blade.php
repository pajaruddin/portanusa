...
<ul class="page-breadcrumb">
    ...
    <li>
        <span>Barang Dalam Pengiriman</span>
    </li>
</ul>
@endsection
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Barang Dalam Pengiriman</span>
                </div>
            </div>
...
$(function () {
    var table = $('#tbl-order').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.'order-shipping/data-shipping')}}",
        columns: [
