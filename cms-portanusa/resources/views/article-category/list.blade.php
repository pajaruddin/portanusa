        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Kategori Artikel</span>
                </div>
                <div class="actions">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="/master-category-article/add-category">
                        Tambah Category
                    </a>
                </div>
            </div>
...
$(function () {
    var table = $('#tbl-category').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.'master-category-article'.'/data-category')}}",
        columns: [
