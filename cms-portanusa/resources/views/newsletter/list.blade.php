        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Newsletter</span>
                </div>
                <div class="actions">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="/newsletter/export-newsletter">
                        Export Newsletter
                    </a>
                </div>
            </div>
            <div class="portlet-body ">
                ...
                <table class="table table-striped table-bordered dt-responsive" id="tbl-newsletter">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>id</th>
...
$(function () {
    var table = $('#tbl-newsletter').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.'newsletter'.'/data-newsletter')}}",
        columns: [
    ...
    $("#tbl-newsletter").on("click", "#delete", function (event, state) {
        var id = $(this).data('id');

        var n = new Noty({
            text: 'Hapus Newsletter ?',
            layout: 'center',
            modal: true,
            buttons: [
                Noty.button('YES', 'btn btn-success', function () {
                    $.ajax({
                        ...
                        url: "{{url('/'.$menu.'/'.'delete-newsletter')}}",
                        data: {
                            id: id
                        },
                        type: 'POST',
