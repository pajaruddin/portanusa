        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Service</span>
                </div>
                <div class="actions">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="/master-service/add-service">
                        Tambah Service
                    </a>
                </div>
            </div>
            <div class="portlet-body ">
                ...
                <table class="table table-striped table-bordered dt-responsive" id="tbl-service">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Title</th>
...
$(function () {
    var table = $('#tbl-service').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.'master-service'.'/data-service')}}",
        columns: [
    ...
    $("#tbl-service").on("click", "#delete", function (event, state) {
        var id = $(this).data('id');
