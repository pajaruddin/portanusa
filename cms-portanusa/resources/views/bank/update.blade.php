    ...
    <div class="col-md-12">
        <div class="portlet light portlet-fit portlet-form">
            ...
            <div class="portlet-body ">
                <!-- BEGIN FORM-->
                <form method="POST" action="{{ url($menu."/".$submenu."/".$bank->id) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" role="form">
                    {{ csrf_field() }}
                    @include('bank.form')
                </form>
                <!-- END FORM-->
