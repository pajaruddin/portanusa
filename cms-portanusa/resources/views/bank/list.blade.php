...
@section('title') Master Bank @endsection
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Bank</span>
                </div>
                <div class="actions">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="/master-bank/add-bank">
                        Tambah Bank
                    </a>
                </div>
            </div>
            <div class="portlet-body ">
                ...
                <table class="table table-striped table-bordered dt-responsive" id="tbl-bank">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>id</th>
...
$(function () {
    var table = $('#tbl-bank').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.'master-bank'.'/data-bank')}}",
        columns: [
            {"data": "rownum", "searchable": false},
            {"data": "id", "visible":false, "searchable": false},
            {"data": "name"},
            {"data": "no_rek", "orderable": false, "searchable": false},
            {"data": "name_of"},
    ...
    $("#tbl-bank").on("click", "#delete", function (event, state) {
        var id = $(this).data('id');
