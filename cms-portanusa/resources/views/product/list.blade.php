        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Produk</span>
                </div>
                <div class="actions">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="/master-product/add-product">
                        Tambah Produk
                    </a>
                </div>
            </div>
...
$(function () {
    var table = $('#tbl-product').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{url('/'.'master-product'.'/data-product')}}",
        columns: [
    ...
    $('#tbl-product').on('switchChange.bootstrapSwitch', 'input[name="active"]', function (event, state) {
        ...
        $.ajax({
            ...
            url: "{{url('/'.'master-product'.'/active-master-product')}}",
            data: {
                active: active,
                id: id
            },
    ...
    $('#tbl-product').on('switchChange.bootstrapSwitch', 'input[name="able"]', function (event, state) {
        ...
        $.ajax({
            ...
            url: "{{url('/'.'master-product'.'/able-master-product')}}",
            data: {
                able: active,
                id: id
            },
