...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="/master-catalogue">Produk Katalog</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span>Edit</span>
    ...
    <div class="col-md-12">
        <div class="portlet light portlet-fit portlet-form">
            ...
            <div class="portlet-body ">
                <!-- BEGIN FORM-->
                <form method="POST" action="{{ url($menu."/".$submenu."/".$catalogue->id) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" role="form">
                    {{ csrf_field() }}
