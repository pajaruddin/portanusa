        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-madison sbold uppercase">Daftar Karir</span>
                </div>
                <div class="actions">
...
$(function () {
    ...
    $('#tbl-career').on('switchChange.bootstrapSwitch', 'input[name="active"]', function (event, state) {
        var id = $(this).data('id');
        var active = "";
        if (state) {
            active = 'T';
        ...
        $.ajax({
            ...
            url: "{{url('/'.'career-post'.'/active-career')}}",
            data: {
                enable: active,
                id: id
            },
